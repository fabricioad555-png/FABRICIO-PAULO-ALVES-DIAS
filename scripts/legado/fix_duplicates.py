...
# Remove anything from 'import { GoogleGenAI }' down to just before '// Start Express and Vite Middleware'
pattern = r'import \{ GoogleGenAI \} from "@google/genai";[\s\S]*?(?=\/\/ Start Express and Vite Middleware)'
